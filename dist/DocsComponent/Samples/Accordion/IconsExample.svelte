...
<SampleWrapper>
	...
	<div slot="html">
		<TagCode name="Accordion" props={['title="accordion title 1"']}>
			accordion content sample
		</TagCode>
		<TagCode name="Accordion" props={['title="accordion title 2"', 'icon="arrow"']}>
			accordion content sample
		</TagCode>
		<TagCode name="Accordion" props={['title="accordion title 3"', 'icon="plus"']}>
			accordion content sample
		</TagCode>
	</div>
	<div slot="preview" class="w-full">
		<Accordion title="accordion title 1">accordion content sample</Accordion>
		<Accordion title="accordion title 2" open icon="arrow">accordion content sample</Accordion>
		<Accordion title="accordion title 3" icon="plus">accordion content sample</Accordion>
	</div>
</SampleWrapper>
