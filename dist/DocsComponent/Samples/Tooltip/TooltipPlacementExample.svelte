<script lang="ts">
	...
	import type { TooltipPlacement } from '../../../components/Tooltip/Tooltip.type.js';
...
<SampleWrapper>
	<div slot="javascript">
		<TagCode name="script">
			import <span class="text-green-600">Tooltip</span> from '{$importDocumentSrc}/Tooltip.svelte';
