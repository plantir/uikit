...
export type AvatarMask = 'squircle' | 'decagon' | 'diamond' | 'heart' | 'hexagon' | 'hexagon-2' | 'circle' | 'parallelogram' | 'parallelogram-2' | 'parallelogram-3' | 'parallelogram-4' | 'pentagon' | 'square' | 'star' | 'star-2' | 'triangle' | 'triangle-2' | 'triangle-3' | 'triangle-4' | undefined;
