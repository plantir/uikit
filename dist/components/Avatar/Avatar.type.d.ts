...
export type AvatarMask = 'squircle' | 'decagon' | 'diamond' | 'heart' | 'hexagon' | 'hexagon-2' | 'circle' | 'pentagon' | 'square' | 'star' | 'star-2' | 'triangle' | 'triangle-2' | 'triangle-3' | 'triangle-4' | undefined;
