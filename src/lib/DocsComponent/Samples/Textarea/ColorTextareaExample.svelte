...
{:else}
	<SimpleCode>
		<div class="flex flex-wrap gap-4">
			...
			<TextArea color="accent" label="accent"></TextArea>
			<TextArea color="error" label="error"></TextArea>
			<TextArea color="info" label="info"></TextArea>
			<TextArea color="success" label="success"></TextArea>
